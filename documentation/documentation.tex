...
\item The brower must be able to handle communication with the webserver using https
\item The server will only communicate with the client interface over https (secure http).  All other connections will be automatically switched to https.
