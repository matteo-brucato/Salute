...
\item A patient account may only be allowed to connect with a healthcare provider account
...
\begin{figure}
\includegraphics[scale=0.5]{screenshots/pat_register.png}
\caption{Patient registration}
\end{figure}

\begin{figure}
\includegraphics[scale=0.5]{screenshots/HCP_register.png}
\caption{HCP registration}
\end{figure}

\begin{figure}
\includegraphics[scale=0.5]{screenshots/Welcome_patient.png}
\caption{Welcome patient}
\end{figure}
\clearpage
\begin{figure}
\includegraphics[scale=0.5]{screenshots/hcp_welcome.png}
\caption{Welcome HCP}
\end{figure}

\begin{figure}
\includegraphics[scale=0.5]{screenshots/forgot_pwd.png}
\caption{Forgot password}
\end{figure}

\begin{figure}
\includegraphics[scale=0.5]{screenshots/pat_info.png}
\caption{Patient edit info}
\end{figure}

\begin{figure}
\includegraphics[scale=0.5]{screenshots/hcp_edit_info.png}
...
\begin{figure}
\includegraphics[scale=0.5]{screenshots/change_password.png}
\caption{Change password}
\end{figure}

\begin{figure}
\includegraphics[scale=0.5]{screenshots/my_patients.png}
\caption{My patients}
\end{figure}

\begin{figure}
\includegraphics[scale=0.5]{screenshots/patients_profile.png}
\caption{Patient's profile}
\end{figure}

\begin{figure}
\includegraphics[scale=0.5]{screenshots/issuebill.png}
\caption{Issue bill}
\end{figure}

\begin{figure}
\includegraphics[scale=0.5]{screenshots/patient_bills.png}
\caption{Patient's bills}
\end{figure}

\begin{figure}
\includegraphics[scale=0.5]{screenshots/doc_bills.png}
\caption{HCP's bills}
\end{figure}

\begin{figure}
\includegraphics[scale=0.5]{screenshots/Patient_appts.png}
\caption{Patient's appointments}
\end{figure}

\begin{figure}
\includegraphics[scale=0.5]{screenshots/doc_appointments.png}
\caption{HCP's appointments}
\end{figure}

\begin{figure}
\includegraphics[scale=0.5]{screenshots/Messaging.png}
\caption{Messaging}
\end{figure}
