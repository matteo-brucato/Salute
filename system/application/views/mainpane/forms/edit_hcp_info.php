<form method="post" action="/profile/edit_do" id="edit-info">
	<fieldset id="edit-info-fieldset">
		...
		<table>
			...
			<tr>
				<td><label for="fax-input">Specialization</label></td>
				<td><input type="text" name="spec" class="input-field"
					value="<?php echo $curr_info['specialization'];?>" /><br /></td>
			</tr>
			<tr>
				<td><label for="fax-input">Organization Name</label></td>
				<td><input type="text" name="org" class="input-field"
					value="<?php echo $curr_info['org_name'];?>" /><br /></td>
			</tr>
			<tr>
