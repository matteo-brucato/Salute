	...
	foreach ($actions as $action) {
		switch ($action) {
			...
			/*case 'delete-perm':
				...
				break;*/
			case 'change-perms':
				$str .= '<li><a href="/connections/permissions/'.$tuple['account_id'].'">Change shared medical records</a></li>';
				break;
			/*case 'view-all-perm':
			...
			case 'list-mems':
				$str .= '<li><a href="/groups/members/list/'.$tuple['group_id'].'">List Members</a></li>';
				break;
